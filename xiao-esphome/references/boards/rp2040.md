...
# Status LED (RGB LED blue channel is typically on GPIO25)
status_led:
  pin:
    number: GPIO25
    inverted: true
...
|----------|------|-------------|----------|
| D0 | GPIO26 | GPIO26 | ADC |
| D1 | GPIO27 | GPIO27 | ADC |
| D2 | GPIO28 | GPIO28 | ADC |
| D3 | GPIO29 | GPIO29 | ADC |
| D4 | GPIO6 | GPIO6 | I2C SDA |
| D5 | GPIO7 | GPIO7 | I2C SCL |
| D6 | GPIO0 | GPIO0 | UART TX |
| D7 | GPIO1 | GPIO1 | UART RX / CSn |
| D8 | GPIO2 | GPIO2 | SPI SCK |
| D9 | GPIO4 | GPIO4 | SPI MISO |
| D10 | GPIO3 | GPIO3 | SPI MOSI |

RGB LED (blue channel): GPIO25 (typically inverted)

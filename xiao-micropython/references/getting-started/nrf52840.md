...
|----------|------|-------------|-----------|
| D0 | GPIO3 | Pin(3) | A0, ADC, UART TX |
| D1 | GPIO2 | Pin(2) | A1, ADC, UART RX |
| D2 | GPIO29 | Pin(29) | A2, ADC, SDA |
| D3 | GPIO28 | Pin(28) | A3, ADC, SCL |
| D4 | GPIO4 | Pin(4) | GPIO |
| D5 | GPIO5 | Pin(5) | GPIO |
| D6 | GPIO6 | Pin(6) | GPIO |
| D7 | GPIO7 | Pin(7) | GPIO |
| D8 | GPIO8 | Pin(8) | GPIO |
| D9 | GPIO9 | Pin(9) | GPIO |
| D10 | GPIO10 | Pin(10) | GPIO |
| D16-D21 | GPIO16-21 | Pin(16-21) | GPIO |

Built-in LED: Pin(13) (red, active low)
...
i2c = I2C(0, sda=Pin(29), scl=Pin(28), freq=100000)
...
# SPI configuration
spi = SPI(0, sck=Pin(14), mosi=Pin(15), miso=Pin(13), baudrate=1000000)
...
# UART on D0 (TX) and D1 (RX)
uart = UART(0, tx=Pin(3), rx=Pin(2), baudrate=115200)

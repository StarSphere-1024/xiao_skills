...
# User LED / LED_BUILTIN is on GPIO25
led = Pin(25, Pin.OUT)
...
| D4 | GPIO6 | SDA1 | I2C SDA (XIAO standard) |
| D5 | GPIO7 | SCL1 | I2C SCL (XIAO standard) |
| D6 | GPIO0 | TX0 | UART TX (XIAO standard) |
| D7 | GPIO1 | RX0 | UART RX (XIAO standard) |

...
| Name | GPIO | Notes |
|------|------|-------|
| D0 | GPIO26 | ADC | Analog input |
| D1 | GPIO27 | ADC | Analog input |
| D2 | GPIO28 | ADC | Analog input |
| D3 | GPIO29 | ADC | Analog input |
| D4 | GPIO6 | I2C SDA | XIAO standard |
| D5 | GPIO7 | I2C SCL | XIAO standard |
| D6 | GPIO0 | UART TX | XIAO standard |
| D7 | GPIO1 | UART RX / CSn | UART RX; can be SPI CS |
| D8 | GPIO2 | SPI SCK | XIAO standard |
| D9 | GPIO4 | SPI MISO | XIAO standard |
| D10 | GPIO3 | SPI MOSI | XIAO standard |
...
led = machine.Pin(25, machine.Pin.OUT, value=1)  # USER_LED_B (often active-low)
